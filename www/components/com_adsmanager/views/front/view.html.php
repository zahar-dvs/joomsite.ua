		...
		<div class='adsmanager_box_module' align="center">
			...
			?>
				...
				if (isset($row->images[0])) {
					echo "<div align='center'><a href='".$linkTarget."'><img class='okrygmain' src='".$this->get('baseurl')."/images/com_adsmanager/ads/".$row->images[0]->thumbnail."' alt=\"".htmlspecialchars($row->ad_headline)."\" border='0' /></a>";
				} else if ($conf->nb_images > 0) {
					echo "<div align='center'><a href='".$linkTarget."'><img class='okrygmain' src='".ADSMANAGER_NOPIC_IMG."' alt='nopic' border='0' /></a>"; 
				} 	
