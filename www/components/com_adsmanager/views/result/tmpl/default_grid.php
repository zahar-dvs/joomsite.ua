        ...
        <div class="adsmanager-grid">
            ...
            <div class="text-center">
                ...
                if (isset($content->images[0])) {
                    echo "<a href='".$linkTarget."'><img name='adimage".$content->id."' src='".$this->baseurl."images/com_adsmanager/ads/".$content->images[0]->image."' alt=\"".htmlspecialchars($content->ad_headline)."\" /></a>";
