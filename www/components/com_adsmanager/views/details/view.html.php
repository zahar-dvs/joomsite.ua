...
class AdsmanagerViewDetails extends TView
{
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('')." ".JText::_($category->name)." - ".$content->ad_headline);
    ...
    foreach($contents as $content) {
       $linkTarget = TRoute::_( "index.php?option=com_adsmanager&view=details&id=".$content->id."&catid=".$content->catid);
        ...
        <div>
			...
			<div><a href="<?php echo $linkTarget; ?>"><h4><?php echo $content->ad_headline; ?>, <?php echo $content->ad_city; ?></h4></a>	<?php 
						$content->ad_text = str_replace ('<br />'," ",$content->ad_text); 
						$af_text = JString::substr($content->ad_text, 0, 200);
