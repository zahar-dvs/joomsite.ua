        ...
        <div>
            <?php
				...
				<?php
					...
					echo "<a class='btn btn-default btn-lg' href='".$target."'>".JText::_('ADSMANAGER_CONTENT_EDIT')."</a>";
					echo "&nbsp;";
					$target = TRoute::_("index.php?option=com_adsmanager&task=delete&catid=".$this->content->category."&id=".$this->content->id);
					echo "<a class='btn btn-danger' href='".$target."'>".JText::_('ADSMANAGER_CONTENT_DELETE')."</a>";
				?>
			</div></h5>
				<?php
				}
...
<div id="adsblok"><div align="center"><h4><?php echo addslashes(JText::_('ADSMANAGER_POHOWIE')); ?></h4></div>
<?php
