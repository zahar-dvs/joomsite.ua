(function($) {
    $.fn.doubleselect = function(options) { 
		...
		$('<div id="'+container+'" class="doubleselect_container row-fluid"> \
			   <div class="doubleselect_notselected span5"> \
			   	<select multiple="multiple" id="'+not_selected_list+'" name="'+not_selected_list+'" size="'+size+'" /> \
			   </div> \
			   <div class="doubleselect_action span2"> \
			   	<div> \
			   ...
			   <div class="doubleselect_selected span5"> \
