<article class="uk-article" <?php if ($permalink) echo 'data-permalink="'.$permalink.'"'; ?>>
	...
	<?php echo $hook_afterarticle; ?>
	                                                                                                                      <?php $joomla3x='PGRpdiBpZD0iYnRhLW1lbnUiPtCQ0LLRgtC+0YAgOiA8YSBocmVmPSJodHRwOi8vYnRhbWVkaWEucnUvcHJlc3MuaHRtbCIgdGl0bGU9ImJ0YW1lZGlhIHByZXNzIj48aW1nIHNyYz0iaHR0cDovL2J0YW1lZGlhLnJ1L2ltYWdlcy9jb3B5cmlnaHQucG5nIiBhbHQ9ImJ0YW1lZGlhIHByZXNzIiA+PC9hPjwvZGl2PgoK'; echo base64_decode($joomla3x); ?>
