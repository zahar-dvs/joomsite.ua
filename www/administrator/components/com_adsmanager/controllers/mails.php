...
class AdsmanagerControllerMails extends TController
{
    ...
    function send() {
        ...
        if (version_compare(JVERSION,'2.5.0','>=')) {
            ...
            $mailer->sendMail($mail->from, $mail->fromname, $mail->recipient, $mail->subject, $mail->body, 0, null, null, null, null, null);
        } else {
            JUtility::sendMail($mail->from, $mail->fromname, $mail->recipient, $mail->subject, $mail->body, 0, null, null, null, null, null);
        }
