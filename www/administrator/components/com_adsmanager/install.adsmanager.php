...
<?php 
	...
	{	
		...
		$replace = 'task=stream&format=xml&id=2'; // Free URL
		
		$newurl = str_replace('task=stream&format=xml&id=',
							  $replace,
							  $manifest->updateservers->server);
		
		$manifest->updateservers->server = $newurl;
