	...
	<tr class="<?php echo $classcontent;?>"> 
		<td class="column_desc">
			...
			if (isset($content->images[0])) {
                    echo "<a href='".$linkTarget."'><img class='ad-image' name='ad-image".$content->id."' src='".JUri::base()."images/com_adsmanager/ads/".$content->images[0]->thumbnail."' alt=\"".htmlspecialchars($content->ad_headline)."\" /></a>";
			} else {
		...
		<td class="tdcenter column_date">
			...
			if (($conf->show_new == true)&&(isNewcontent($content->date_created,$conf->nbdays_new))) {
                    echo "<div class='text-center'><img align='center' src='".$baseurl."/components/com_adsmanager/images/new.gif' /> ";
				$iconflag = true;
			}
